...
public class ParticleEffect {
	...
	public void pS002() {
        ...
        Particle.DustOptions dustOptions1 = new Particle.DustOptions(Color.fromRGB(255, 30, 30), 1);
	...
	public void pS003() {
		...
		double arrowAngle1 = 110;
		double totalAngle1 = normal.getYaw() + arrowAngle1;
		double dirX1 = Math.cos(Math.toRadians(totalAngle1));
		double dirZ1 = Math.sin(Math.toRadians(totalAngle1));
		
		e1 = normal.clone().add(dirX1*1.5, 0.2, dirZ1*1.5);
	...
	public void pS004() {
        ...
        Particle.DustOptions dustOptions1 = new Particle.DustOptions(Color.fromRGB(55, 55, 55), 1);
		...
		for(int i = 0 ; i < 6 ; i++) {
			e1 = normal.clone().add(dirX3*1.4, 0.9+(i*0.1), dirZ3*1.4);
			world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		}
		
		double arrowAngle4 = 80;
		...
		for(int i = 0 ; i < 6 ; i++) {
			e1 = normal.clone().add(dirX4*1.4, 0.9+(i*0.1), dirZ4*1.4);
			world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		}
		
		world.playSound(normal, Sound.ITEM_SHIELD_BLOCK, 1.0f, 1.0f);
	...
	public void pS006() {
		...
		world.playSound(normal, Sound.ITEM_FIRECHARGE_USE, 4.0f, 1.0f);
	}
	...
	public void pS009() {
		...
		world.playSound(normal, Sound.ENTITY_LIGHTNING_BOLT_THUNDER, 1.0f, 3.0f);
	...
	public void pS012() {
        ...
        Particle.DustOptions dustOptions1 = new Particle.DustOptions(Color.fromRGB(240, 60, 60), 1);
		...
		e1 = normal.clone().add(dirX1*2, 1.2, dirZ1*2);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX2*1.8, 1.3, dirZ2*1.8);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX3*1.6, 1.4, dirZ3*1.6);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX4*1.4, 1.5, dirZ4*1.4);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX5*1.8, 1.1, dirZ5*1.8);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX6*1.6, 1.0, dirZ6*1.6);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX7*1.4, 0.9, dirZ7*1.4);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX8*1.2, 0.8, dirZ8*1.2);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX9*1.2, 1.6, dirZ9*1.2);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		
		world.playSound(normal, Sound.ITEM_TRIDENT_THUNDER, 1.0f, 1.0f);
	...
	public void pS014() {
        ...
        new BukkitRunnable() {
			...
			public void run() {
				...
				e1 = normal.clone().add(dirX1*1.5, 0.9+(time*0.1), dirZ1*1.5);
				world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
				...
				e1 = normal.clone().add(dirX2*1.45, 0.9+(time*0.1), dirZ2*1.45);
				world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
				...
				e1 = normal.clone().add(dirX5*1.45, 0.9+(time*0.1), dirZ5*1.45);
				world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
	...
	public void pS015() {
		...
		for(int i = 0 ; i < 7 ; i++) {
			e1 = normal.clone().add(dirX1*(0.9+i*0.1), 1.1, dirZ1*(0.9+i*0.1));
			world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
			
			e1 = normal.clone().add(dirX1*(0.9+i*0.1), 1.2, dirZ1*(0.9+i*0.1));
			world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
			
			e1 = normal.clone().add(dirX1*(0.9+i*0.1), 1, dirZ1*(0.9+i*0.1));
			world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		}
		...
		for(int i = 0 ; i < 7 ; i++) {
			e1 = normal.clone().add(dirX2*(0.9+i*0.1), 1.1, dirZ2*(0.9+i*0.1));
			world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		}
		...
		for(int i = 0 ; i < 7 ; i++) {
			e1 = normal.clone().add(dirX5*(0.9+i*0.1), 1.1, dirZ5*(0.9+i*0.1));
			world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		}
	...
	public void pS022() {
		...
		Particle.DustOptions dustOptions1 = new Particle.DustOptions(Color.fromRGB(255,50,255), 1);
		...
		world.playSound(normal, Sound.ENTITY_WARDEN_EMERGE, 1.0f, 2.0f);
	}
	
	public void pS023(int rot) {
		
		Location normal = player.getLocation();
		World world = player.getWorld(); 
		Location e1;
		
		Particle.DustOptions dustOptions1 = new Particle.DustOptions(Color.fromRGB(100,10,10), 1);
	...
	public void pS032() {
		...
		e1 = normal.clone().add(dirX1*1.5, 1.1, dirZ1*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX2*1.5, 1.3, dirZ2*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		e1 = normal.clone().add(dirX2*1.5, 1.2, dirZ2*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		
		e1 = normal.clone().add(dirX2*1.5, 1.0, dirZ2*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		e1 = normal.clone().add(dirX2*1.5, 0.9, dirZ2*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX9*1.5, 1.4, dirZ9*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		e1 = normal.clone().add(dirX9*1.5, 1.3, dirZ9*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		
		e1 = normal.clone().add(dirX9*1.5, 0.9, dirZ9*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		e1 = normal.clone().add(dirX9*1.5, 0.8, dirZ9*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX5*1.5, 1.3, dirZ5*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		e1 = normal.clone().add(dirX5*1.5, 1.2, dirZ5*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		
		e1 = normal.clone().add(dirX5*1.5, 1.0, dirZ5*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		e1 = normal.clone().add(dirX5*1.5, 0.9, dirZ5*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX8*1.5, 1.4, dirZ8*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		e1 = normal.clone().add(dirX8*1.5, 1.3, dirZ8*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		
		e1 = normal.clone().add(dirX8*1.5, 0.9, dirZ8*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		e1 = normal.clone().add(dirX8*1.5, 0.8, dirZ8*1.5);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		
		world.playSound(normal, Sound.ENTITY_PLAYER_ATTACK_SWEEP, 1.0f, 1.5f);
	}
	
	public void pS033() {
		Location normal = player.getLocation();
		World world = player.getWorld(); 
		Particle.DustOptions dustOptions1 = new Particle.DustOptions(Color.fromRGB(150, 150, 150), 2);
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				if(time % 2 == 0) {
					e1 = normal.clone().add(Math.cos(var), 1, Math.sin(var));
					world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
					
					e1 = normal.clone().add(Math.cos(var)*1.5, 1, Math.sin(var)*1.5);
					world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
					
					e1 = normal.clone().add(Math.cos(var)*2, 1, Math.sin(var)*2);
					world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
					
					e1 = normal.clone().add(Math.cos(var)*2.5, 1, Math.sin(var)*2.5);
					world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
					
					e1 = normal.clone().add(Math.cos(var)*3, 1, Math.sin(var)*3);
					world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		world.playSound(normal, Sound.ITEM_TRIDENT_THROW, 1.5f, 0.3f);
	}
	...
	public void pS034() {
		...
		e1 = normal.clone().add(dirX1*0.6, 1.1, dirZ1*0.6);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		e1 = normal.clone().add(dirX1*1.0, 1.1, dirZ1*1.0);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		e1 = normal.clone().add(dirX1*1.4, 1.1, dirZ1*1.4);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX2*0.4, 1.1, dirZ2*0.4);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		e1 = normal.clone().add(dirX2*1.2, 1.1, dirZ2*1.2);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		...
		e1 = normal.clone().add(dirX5*0.8, 1.1, dirZ5*0.8);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		e1 = normal.clone().add(dirX5*1.6, 1.1, dirZ5*1.6);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);

		world.playSound(normal, Sound.ENTITY_LIGHTNING_BOLT_THUNDER, 0.6f, 3.0f);
	}
	...
	public void pS034_1() {
		...
		double arrowAngle1 = 90;
		double totalAngle1 = normal.getYaw() + arrowAngle1 + 30;
		double dirX1 = Math.cos(Math.toRadians(totalAngle1));
		double dirZ1 = Math.sin(Math.toRadians(totalAngle1));
		...
		double arrowAngle2 = 100;
		double totalAngle2 = normal.getYaw() + arrowAngle2 + 30;
		double dirX2 = Math.cos(Math.toRadians(totalAngle2));
		double dirZ2 = Math.sin(Math.toRadians(totalAngle2));
		...
		double arrowAngle5 = 80;
		double totalAngle5 = normal.getYaw() + arrowAngle5 + 30; 
		double dirX5 = Math.cos(Math.toRadians(totalAngle5));
		double dirZ5 = Math.sin(Math.toRadians(totalAngle5));
	...
	public void pS036() {
        ...
        Particle.DustOptions dustOptions1 = new Particle.DustOptions(Color.fromRGB(204, 204, 52), 2);
        ...
        new BukkitRunnable() {
			...
			public void run() {
				...
				e1 = normal.clone().add(dirX1*1.5, 1.5-(time*0.1), dirZ1*1.5);
				world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
				...
				e1 = normal.clone().add(dirX2*1.45, 1.5-(time*0.1), dirZ2*1.45);
				world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
				...
				e1 = normal.clone().add(dirX5*1.45, 1.5-(time*0.1), dirZ5*1.45);
				world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
	...
	public void pS037() {
        ...
        Particle.DustOptions dustOptions2 = new Particle.DustOptions(Color.fromRGB(51, 204, 204), 1);
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				if(time % 3 == 0) {
					...
					for(int i = 0 ; i < 16 ; i++) {
						e1 = normal.clone().add(Math.cos(var)*4, 0.2, Math.sin(var)*4);
						world.spawnParticle(Particle.REDSTONE, e1, 2, dustOptions1);
		...
		world.playSound(normal, Sound.BLOCK_ANVIL_LAND, 0.5f, 0.5f);
	}
	...
	public void mobS007() {
		...
		e1 = normal.clone().add(dirX10*1, 1.7, dirZ10*1);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		
		double arrowAngle11 = 120;
		...
		e1 = normal.clone().add(dirX11*0.8, 1.8, dirZ11*0.8);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		
		double arrowAngle12 = 65;
		...
		e1 = normal.clone().add(dirX12*1, 0.7, dirZ12*1);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		
		double arrowAngle13 = 60;
		double totalAngle13 = normal.getYaw() + arrowAngle13;
		double dirX13 = Math.cos(Math.toRadians(totalAngle13));
		double dirZ13 = Math.sin(Math.toRadians(totalAngle13));
		
		e1 = normal.clone().add(dirX13*0.8, 0.6, dirZ13*0.8);
		world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
	...
	public void mobS008() {
		...
		for(int i = 1 ; i < 13 ; i++) {
			e1 = normal.clone().add(dirX1*(0.5*i), 0.8, dirZ1*(0.5*i));
			world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		}
		...
		for(int i = 1 ; i < 13 ; i++) {
			e1 = normal.clone().add(dirX2*(0.5*i), 0.8, dirZ2*(0.5*i));
			world.spawnParticle(Particle.REDSTONE, e1, 4, dustOptions1);
		}
	...
	public void mobS009() {
		...
		Particle.DustOptions dustOptions1 = new Particle.DustOptions(Color.fromRGB(60, 60, 60), 1);
