			...
			public void run() {
				...
				if(time % 30 == 0) {
					if(ary[cnt].substring(0, 2).equals("tp")) {
						...
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0197")) {
						QuestBoard qb = new QuestBoard();
						qb.q0197(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0198")) {
						QuestBoard qb = new QuestBoard();
						qb.q0198(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0199")) {
						QuestBoard qb = new QuestBoard();
						qb.q0199(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0200")) {
						QuestBoard qb = new QuestBoard();
						qb.q0200(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0201")) {
						QuestBoard qb = new QuestBoard();
						qb.q0201(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0202")) {
						QuestBoard qb = new QuestBoard();
						qb.q0202(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0203")) {
						QuestBoard qb = new QuestBoard();
						qb.q0203(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0204")) {
						QuestBoard qb = new QuestBoard();
						qb.q0204(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0205")) {
						QuestBoard qb = new QuestBoard();
						qb.q0205(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0206")) {
						QuestBoard qb = new QuestBoard();
						qb.q0206(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0207")) {
						QuestBoard qb = new QuestBoard();
						qb.q0207(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0208")) {
						QuestBoard qb = new QuestBoard();
						qb.q0208(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0209")) {
						QuestBoard qb = new QuestBoard();
						qb.q0209(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0210")) {
						QuestBoard qb = new QuestBoard();
						qb.q0210(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0211")) {
						QuestBoard qb = new QuestBoard();
						qb.q0211(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0212")) {
						QuestBoard qb = new QuestBoard();
						qb.q0212(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0213")) {
						QuestBoard qb = new QuestBoard();
						qb.q0213(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0214")) {
						QuestBoard qb = new QuestBoard();
						qb.q0214(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0215")) {
						QuestBoard qb = new QuestBoard();
						qb.q0215(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0216")) {
						QuestBoard qb = new QuestBoard();
						qb.q0216(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0217")) {
						QuestBoard qb = new QuestBoard();
						qb.q0217(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0218")) {
						QuestBoard qb = new QuestBoard();
						qb.q0218(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0219")) {
						QuestBoard qb = new QuestBoard();
						qb.q0219(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0220")) {
						QuestBoard qb = new QuestBoard();
						qb.q0220(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0221")) {
						QuestBoard qb = new QuestBoard();
						qb.q0221(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0222")) {
						QuestBoard qb = new QuestBoard();
						qb.q0222(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0223")) {
						QuestBoard qb = new QuestBoard();
						qb.q0223(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0224")) {
						QuestBoard qb = new QuestBoard();
						qb.q0224(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0225")) {
						QuestBoard qb = new QuestBoard();
						qb.q0225(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0226")) {
						QuestBoard qb = new QuestBoard();
						qb.q0226(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0227")) {
						QuestBoard qb = new QuestBoard();
						qb.q0227(player, 0, true);
						...
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0228")) {
						QuestBoard qb = new QuestBoard();
						qb.q0228(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0229")) {
						QuestBoard qb = new QuestBoard();
						...
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0235")) {
						QuestBoard qb = new QuestBoard();
						qb.q0235(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0236")) {
						QuestBoard qb = new QuestBoard();
						qb.q0236(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0237")) {
						QuestBoard qb = new QuestBoard();
						qb.q0237(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0238")) {
						QuestBoard qb = new QuestBoard();
						qb.q0238(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0239")) {
						QuestBoard qb = new QuestBoard();
						qb.q0239(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0240")) {
						QuestBoard qb = new QuestBoard();
						qb.q0240(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					} else if(ary[cnt].substring(0, 5).equals("q0241")) {
						QuestBoard qb = new QuestBoard();
						qb.q0241(player, 0, true);
						player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0f, 3.0f);
					}
